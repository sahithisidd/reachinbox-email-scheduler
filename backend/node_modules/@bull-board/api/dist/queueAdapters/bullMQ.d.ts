...
import { AppJobScheduler, JobCleanStatus, JobCounts, JobSchedulerRepeatOptions, JobSchedulerUpdateResult, JobStatus, MetricsType, ObliterateOptions, QueueAdapterOptions, QueueDefaultJobOptions, QueueJob, QueueJobOptions, QueueMetrics, QueueRateLimit, QueueWorker, RedisStats, Status } from '../../typings/app';
...
export declare class BullMQAdapter extends BaseAdapter {
    ...
    resume(): Promise<void>;
    empty(): Promise<void>;
    obliterate({ force }?: ObliterateOptions): Promise<void>;
     ...
     */
    getArmedJobSchedulerId(job: QueueJob): Promise<string | null>;
    ...
    runJobSchedulerNow(id: string): Promise<QueueJob | 'not-found'>;
    ...
    setConfiguredRateLimit({ max, duration }: QueueRateLimit): Promise<void>;
