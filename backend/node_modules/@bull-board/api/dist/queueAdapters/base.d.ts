import { AppJobScheduler, BullBoardRequest, FormatterField, JobCleanStatus, JobCounts, JobSchedulerRepeatOptions, JobSchedulerUpdateResult, JobStatus, MetricsType, ObliterateOptions, QueueAdapterOptions, QueueDefaultJobOptions, QueueJob, QueueJobOptions, QueueMetrics, QueueRateLimit, QueueType, QueueWorker, RedisStats, Status } from '../../typings/app';
...
export declare abstract class BaseAdapter {
    ...
    abstract obliterate(opts?: ObliterateOptions): Promise<void>;
    abstract promoteAll(): Promise<void>;
    getArmedJobSchedulerId(_job: QueueJob): Promise<string | null>;
     ...
     */
    abstract runJobSchedulerNow(id: string): Promise<QueueJob | 'not-found'>;
    /**
     * Whether {@link runJobSchedulerNow} does anything. False for Bull, which stores no template to
     * re-add from.
     */
    get supportsJobSchedulerRun(): boolean;
    ...
    get supportsGlobalRateLimit(): boolean;
    getConfiguredRateLimit(): Promise<QueueRateLimit | null>;
    setConfiguredRateLimit(_limit: QueueRateLimit): Promise<void>;
