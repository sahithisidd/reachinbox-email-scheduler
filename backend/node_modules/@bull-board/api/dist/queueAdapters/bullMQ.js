...
class BullMQAdapter extends base_1.BaseAdapter {
    ...
    get supportsJobSchedulerRun() {
        return true;
    }
    async runJobSchedulerNow(id) {
        var _a, _b;
        ...
        return this.queue.add(scheduler.name, (_a = scheduler.template) === null || _a === void 0 ? void 0 : _a.data, (_b = scheduler.template) === null || _b === void 0 ? void 0 : _b.opts);
    }
