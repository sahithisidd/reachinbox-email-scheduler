...
function getFlowProducer(queues, queueName) {
    var _a;
    const adapter = (_a = buildQueueNameLookup(queues).get(queueName)) !== null && _a !== void 0 ? _a : findBullMQAdapter(queues);
...
async function getFlowTree(queues, queueName, jobId, window) {
