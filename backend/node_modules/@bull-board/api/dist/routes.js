...
exports.appRoutes = {
    ...
    api: [
        ...
        { method: 'get', route: '/api/job-schedulers', handler: jobSchedulers_1.jobSchedulersHandler },
        {
            method: 'get',
